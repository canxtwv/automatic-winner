...
import com.affine.Veg.entity._
import com.affine.Veg.entity.VegEntityDatabase
...
object VegServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new VegService(serviceIdentity, producer, untypedSystem, new VegEntityDatabase(context.system, producer))
  ...
  val system = akka.actor.ActorSystem("veg")
