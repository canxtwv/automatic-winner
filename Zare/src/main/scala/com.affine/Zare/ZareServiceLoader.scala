...
import com.affine.Zare.entity._
import com.affine.Zare.entity.ZareEntityDatabase
...
object ZareServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new ZareService(serviceIdentity, producer, untypedSystem, new ZareEntityDatabase(context.system))
  ...
  val system = akka.actor.ActorSystem("zare")
