...
import com.affine.Taco.entity._
import com.affine.Taco.entity.TestEntityDatabase
...
object TacoServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new TacoService(serviceIdentity, producer, untypedSystem, new TestEntityDatabase(context.system, producer))
  ...
  val system = akka.actor.ActorSystem("taco")
