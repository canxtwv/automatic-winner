...
import com.affine.Test.entity._
import com.affine.Test.entity.TestEntityDatabase
...
object TestServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new TestService(serviceIdentity, producer, untypedSystem, new TestEntityDatabase(context.system))
