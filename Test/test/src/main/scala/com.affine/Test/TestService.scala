...
class TestService(serviceIdentifier: ServiceIdentifier, publisher: Publisher, sys: ActorSystem, testDb: TestDatabase) extends Service(serviceIdentifier,publisher) with AvroByteStreams{
