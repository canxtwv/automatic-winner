...
import com.affine.Demo.entity._
import com.affine.Demo.entity.DemoEntityDatabase
...
object DemoServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new DemoService(serviceIdentity, producer, untypedSystem, new DemoEntityDatabase(context.system))
  ...
  val system = akka.actor.ActorSystem("demo")
