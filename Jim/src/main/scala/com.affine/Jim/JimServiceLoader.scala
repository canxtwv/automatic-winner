...
import com.affine.Jim.entity._
import com.affine.Jim.entity.JimEntityDatabase
...
object JimServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new JimService(serviceIdentity, producer, untypedSystem, new JimEntityDatabase(context.system))
  ...
  val system = akka.actor.ActorSystem("jim")
