...
import com.affine.Tea.entity._
import com.affine.Tea.entity.TeaEntityDatabase
...
object TeaServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new TeaService(serviceIdentity, producer, untypedSystem, new TeaEntityDatabase(context.system))
  ...
  val system = akka.actor.ActorSystem("tea")
